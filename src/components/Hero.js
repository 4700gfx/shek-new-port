      ...
      <div className='hero-container bg-darkRed h-auto w-11/12 md:w-4/5 p-4 md:p-8 lg:p-10 my-10 mx-auto flex flex-col lg:flex-row justify-center items-center rounded-3xl'>
        ...
        <div className='hero-text flex flex-col w-full lg:w-1/2 text-center lg:text-left'>
          ...
          <div className='hero-buttons flex flex-col lg:flex-row mt-4'>
            <button className='bg-richRed mb-3 lg:mb-0 lg:mr-3 w-full lg:w-1/6 p-2 md:p-3 text-sm md:text-base rounded-full hover:bg-deepRed transition duration-300'>
              Download
            </button>
            <button className='bg-richRed w-full lg:w-1/6 p-2 md:p-3 text-sm md:text-base rounded-full hover:bg-deepRed transition duration-300'>
              Projects
            </button>
          </div>
        </div>
